				...
				<!-- Input form -->
						<?php
							...
							while ($row = mysqli_fetch_row($rs)) {
								...
								echo '<td><a href="Show_A.php?identifier='."$row[3]".'">'."$row[0] $row[1]".'</a></td>';
								echo "<td>$row[2]</td>";
								echo "</tr>\n";
							}
							echo "</table><hr>";
							...
							if (!empty($review[0])) {
								...
								while ($row_comment = mysqli_fetch_row($rs_comment)) {
									echo "<font color = 'red'>$row_comment[0]</font> rates the this movie with score <b> $row_comment[1]</b> and left a review at $row_comment[2]<br>comment:<br>$row_comment[3]<br>";
								}
								echo "<hr>";
							} else {
								echo "<h4><b>User Review : </b></h4>";
								echo '<a href= "add_comment.php?MovieID='."$movie[0]".'">Be the first one to leave your comment!</a><hr>';
							}
