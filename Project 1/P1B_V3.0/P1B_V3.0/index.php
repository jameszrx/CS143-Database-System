...
<div id="wrapper">
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 col-lg-offset-2 align-middle">
        <br>
        <br>
        <br>
        <br>
        ...
        <br>
        <br>
        <h2><strong>Welcome to CS143 Database Query System!</strong></h2>
        <hr>
        <p><span class="glyphicon glyphicon-star"></span> please select a functionality on the top left corner.</p>
        </div>
      </div>
    </div>
  </div>
